!(function () {
  ...
  function sn(n, t, e) {
    return (
      isNaN(n) && (n = 0), isNaN(t) && (t = 0), new hn(e, Math.cos((n *= Yo)) * t, Math.sin(n) * t)
    );
  }
  function hn(n, t, e) {
  ...
  function qn(n, t, e) {
    ...
    var i = e + t,
      u = { c: n, t: i, n: null };
    return (
      aa ? (aa.n = u) : (oa = u), (aa = u), la || ((ca = clearTimeout(ca)), (la = 1), fa(Tn)), u
    );
  }
  function Tn() {
    var n = Rn(),
    ...
    function e(n, t, e, r) {
      for (var i, u, o, a = 0, l = t.length, c = e.length; l > a; ) {
        ...
        if (((i = t.charCodeAt(a++)), 37 === i)) {
          if (
            ((o = t.charAt(a++)), (u = C[o in ya ? t.charAt(a++) : o]), !u || (r = u(n, e, r)) < 0)
          )
            return -1;
  ...
  function Ot(n, t) {
    ...
    for (var a = 0, l = t.length; l > a; ++a) {
      ...
      if (f)
        for (
          var s = c[0], h = s[0], p = s[1] / 2 + Fo / 4, g = Math.sin(p), v = Math.cos(p), d = 1;
          ;
      ...
      return {
        ...
        point: function (s, h) {
          ...
          if (
            ...
            v !== l &&
              ((p = r(e, g)),
              (wt(e, p) || wt(g, p)) && ((g[0] += Uo), (g[1] += Uo), (v = t(g[0], g[1])))),
            v !== l)
          )
            (f = 0),
              v
  ...
  function ar(n, t) {
    ...
    for (il = [], ul = new Array(n.length), ol = new er(), ll = new er(); ; )
      if (((i = al), u && (!i || u.y < i.y || (u.y === i.y && u.x < i.x))))
        (u.x === e && u.y === r) || ((ul[u.i] = new Ye(u)), He(u), (e = u.x), (r = u.y)),
          (u = n.pop());
      else {
        if (!i) break;
        Fe(i.arc);
  ...
  function vr(n, t) {
    ...
    return function (n) {
      return (
        "#" + bn(Math.round(e + u * n)) + bn(Math.round(r + o * n)) + bn(Math.round(i + a * n))
      );
    };
  }
  function dr(n, t) {
  ...
  function ri(n, t, e) {
    ...
    if (((n.charge = 0), !n.leaf))
      for (var u, o = n.nodes, a = o.length, l = -1; ++l < a; )
        (u = o[l]),
          null != u &&
            (ri(u, t, e), (n.charge += u.charge), (r += u.charge * u.cx), (i += u.charge * u.cy));
    if (n.point) {
    ...
    if ((e = n.children) && (c = e.length)) {
      ...
      if (
        ...
        for (
          ...
          g
            ? (d > v || (v == d && i.r < r.r) ? Si(r, (i = a)) : Si((r = l), i), o--)
            : (wi(r, u), (i = u), t(u));
        }
      var y = (f + s) / 2,
        m = (h + p) / 2,
  ...
  function Mu(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o = "function" == typeof n ? (u = n) : (u = Tl.get(n) || xu).key), t)
          : o;
      }),
    ...
    (Co.attr = function (n, t) {
      if (arguments.length < 2) {
        if ("string" == typeof n) {
          var e = this.node();
          return (
            (n = ao.ns.qualify(n)), n.local ? e.getAttributeNS(n.space, n.local) : e.getAttribute(n)
          );
        }
    ...
    (Co.data = function (n, t) {
      function e(n, e) {
        ...
        if (t) {
          ...
          for (r = -1; ++r < o; )
            (i = n[r]) &&
              (y.has((d = t.call(i, i.__data__, r))) ? (v[r] = i) : y.set(d, i), (m[r] = d));
          for (r = -1; ++r < s; )
          ...
          return (
            r ||
              (r = ao.behavior
                ...
                .on("dragend.force", ni)),
            arguments.length
              ? void this.on("mouseover.force", ti).on("mouseout.force", ei).call(r)
              : r
          );
        }),
        ao.rebind(l, c, "on")
          ...
          if (Fo > h) {
            var D = null == S ? [_, w] : null == x ? [m, M] : Re([m, M], [S, k], [x, b], [_, w]),
              ...
              H =
                ...
                Math.sin(
                  Math.acos(
                    (P * j + U * F) / (Math.sqrt(P * P + U * U) * Math.sqrt(j * j + F * F))
                  ) / 2
                ),
  ...
  (Yl.call = Co.call),
    ...
    (Yl.transition = function () {
      for (
        var n, t, e, r, i = this.id, u = ++Zl, o = this.namespace, a = [], l = 0, c = this.length;
        c > l;
        l++
      ) {
        a.push((n = []));
