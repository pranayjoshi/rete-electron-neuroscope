                  5.34401973764, 5.22125973611, 5.12485045619, 5.05037962112, 4.99699982231,
                  4.96155789635, 4.94441828777
                ]
              ]
            }
          };
          ...
          var Fft = function Fft(radix) {
            ...
            var windowCalculation = {
              ...
              nuttall4a: {
                calc: function calc(n, N) {
                  var z = (PI2 * n) / (N - 1);
                  return (
                    0.338946 - 0.481973 * cos(z) + 0.161054 * cos(2 * z) - 0.018027 * cos(3 * z)
                  );
                },
                values: [],
              ...
              nuttall4b: {
                calc: function calc(n, N) {
                  var z = (PI2 * n) / (N - 1);
                  return (
                    0.355768 - 0.481973 * cos(z) + 0.144232 * cos(2 * z) - 0.012604 * cos(3 * z)
                  );
                },
                values: [],
              ...
              nuttall4c: {
                calc: function calc(n, N) {
                  var z = (PI2 * n) / (N - 1);
                  return (
                    0.3635819 - 0.4891775 * cos(z) + 0.1365995 * cos(2 * z) - 0.0106411 * cos(3 * z)
                  );
                },
                values: [],
              ...
              sft4m: {
                calc: function calc(n, N) {
                  var z = (PI2 * n) / (N - 1);
                  return (
                    0.241906 - 0.460841 * cos(z) + 0.2552381 * cos(2 * z) - 0.041872 * cos(3 * z)
                  );
                },
                values: [],
            ...
            var windowFunctions = function windowFunctions(params) {
              if (windowCalculation[params.name].values.length !== params.N) {
                ...
                windowCalculation[params.name].values[params.n] =
                  windowCalculation[params.name].correction *
                  windowCalculation[params.name].calc(params.n, params.N, params.a);
            ...
            var self = {
              ...
              magnitude: function magnitude(params) {
                ...
                for (var cnt = 0; cnt < params.re.length; cnt++) {
                  ret.push(
                    Math.sqrt(params.re[cnt] * params.re[cnt] + params.im[cnt] * params.im[cnt])
                  );
                }
                return ret;
              },
          ...
          var FirCoeffs = function FirCoeffs() {
            ...
            var calcKImpulseResponse = function calcKImpulseResponse(params) {
              ...
              for (cnt = 0; cnt <= Np; cnt++) {
                ret[Np + cnt] =
                  (A[cnt] * ino(beta * Math.sqrt(1 - (cnt * cnt) / (Np * Np)))) / inoBeta;
              }
              for (cnt = 0; cnt < Np; cnt++) {
                ret[cnt] = ret[o - 1 - cnt];
              }
            ...
            var self = {
              ...
              filtfilt: function filtfilt(input, overwrite) {
                return runMultiFilterReverse(
                  runMultiFilter(input, z, doStep, overwrite),
                  z,
                  doStep,
                  true
                );
        ...
        function (require, module, exports) {
          ...
          var IirCoeffs = function IirCoeffs() {
            var preCalc = function preCalc(params, coeffs) {
              ...
              if (params.BW) {
                pre.alpha =
                  Math.sin(w) * Math.sinh(((Math.log(2) / 2) * params.BW * w) / Math.sin(w));
              } else {
              ...
              lowpassMZ: function lowpassMZ(params) {
                ...
                coeffs.a.push(
                  -Math.pow(Math.E, s * w) *
                    2 *
                    Math.cos(
                      -w * Math.sqrt(Math.abs(Math.pow(as, 2) / (4 * Math.pow(bs, 2)) - 1 / bs))
                    )
                );
        ...
        function (require, module, exports) {
          ...
          var IirFilter = function IirFilter(filter) {
            ...
            var biquadResponse = function biquadResponse(params, s) {
              ...
              var p = complex.mul(
                s.k,
                complex.add(s.b0, complex.mul(z, complex.add(s.b1, complex.mul(s.b2, z))))
              );
            ...
            var self = {
              ...
              filtfilt: function filtfilt(input, overwrite) {
                return runMultiFilterReverse(
                  runMultiFilter(input, cf, doStep, overwrite),
                  cf,
                  doStep,
                  true
                );
        ...
        function (require, module, exports) {
          ...
          exports.evaluatePhase = function (res) {
            ...
            for (cnt = 1; cnt < phase.length; cnt++) {
              ...
              res[cnt].groupDelay =
                (res[cnt].unwrappedPhase - res[cnt - 1].unwrappedPhase) / (pi / res.length);
