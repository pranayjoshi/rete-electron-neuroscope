(function (root, factory) {
  if (typeof define === "function" && define.amd) {
    define(["d3"], function (_d3) {
      return (root.Rickshaw = factory(window.d3));
    });
  } else if (typeof exports === "object") {
    //module.exports = factory(require("d3"));
    root.Rickshaw = factory(window.d3);
    window.Rickshaw = root.Rickshaw;
  } else {
    root.Rickshaw = factory(window.d3);
  }
})(this, function (_d3) {
  ...
  Rickshaw.Fixtures.Number.formatBase1024KMGTP = function (y) {
    ...
    if (abs_y >= 0x4000000000000) {
      return (y / 0x4000000000000).toFixed(2) + "P";
      ...
      this.graph.series.active().forEach(function (series) {
        ...
        for (var i = approximateIndex; i < data.length - 1; ) {
          ...
          if (data[i].x <= domainX && data[i + 1].x > domainX) {
            dataIndex =
              Math.abs(domainX - data[i].x) < Math.abs(domainX - data[i + 1].x) ? i : i + 1;
            break;
          }
